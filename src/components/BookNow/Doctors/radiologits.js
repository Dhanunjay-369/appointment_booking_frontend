...
import Bindumathi_P_L from "../images/Doctors/lab_report_analyst/Bindumathi_P_L.jpg";
import Divya_K_S from "../images/Doctors/lab_report_analyst/Divya_K_S.jpg";
import Kanchan from "../images/Doctors/lab_report_analyst/Kanchan.jpg";
...
function Radiologist()
{
    ...
    const changeDisplay=()=>{
        document.getElementById("radiology").style.display="none";
                ...
                <div class="doctor-content">
                    <div class="doctor-content-holder  mx-auto my-auto">
                        ...
                        <div class="doctor1">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={Bindumathi_P_L} alt="Doctor" height="196" width="196"/>
                                </div>
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    ...
                                    onClick={()=>saveDocInfo('1','Dr.Bindumathi P L','MBBS-General Medicine, MD-General Medicine','Lab Report Analyst')} >Book Visit</button>
                                </div>
                        ...
                        <div class="doctor2">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={Divya_K_S} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    <div class="doctor-field mb-2 py-1 px-1">
                                        Lab Report Analyst
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default"
                                    onClick={()=>saveDocInfo('2','Dr.Divya K S','MBBS-General Medicine, DNB-General Medicine','Lab Report Analayst')} 
                                    >Book Visit</button>
                                </div>
                                {/* <div class="doctor-know-more mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default">Book Know More</button>
                        ...
                        <div class="doctor3">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={Kanchan} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    <div class="doctor-field mb-2 py-1 px-1">
                                        Lab Report Analyst
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default"
                                    onClick={()=>saveDocInfo('3','Dr.Kanchan','MBBS-General Medicine, MD-General Medicine','Lab Report Analyst')} 
                                    >Book Visit</button>
                                </div>
                                {/* <div class="doctor-know-more mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default">Book Know More</button>
