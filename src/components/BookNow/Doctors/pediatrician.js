...
import Lingaraj_Mulage from "../images/Doctors/pediatrician/Lingaraj_Mulage.jpg";
import Gowri_Somayaji from "../images/Doctors/pediatrician/Gowri_Somayaji.jpg";
import Subba_rao from "../images/Doctors/pediatrician/Subba_rao.jpeg";
...
function Pediatrician()
{
    ...
    const changeDisplay=()=>{
        document.getElementById("pediatrician").style.display="none";
    ...
    const saveDocInfo=(id,name,qual,field)=>{
        setDocId(id);
        if(id==='1')
            setDoc(Lingaraj_Mulage);
        else if(id==='2')
            setDoc(Gowri_Somayaji);
        else if(id==='3')
            setDoc(Subba_rao);
        setDocName(name);
        setDocQual(qual);
                ...
                <div class="doctor-content">
                    <div class="doctor-content-holder  mx-auto my-auto">
                        ...
                        <div class="doctor1">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={Lingaraj_Mulage} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    ...
                                    <div class="doctor-qualification mb-2 py-1 px-1">
                                        MBBS-General Medicine, MD-Paediatrics
                                    </div>
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    ...
                                    onClick={()=>saveDocInfo('1','Dr.Lingaraj Mulage','MBBS-General Medicine, MD-Paediatrics','Pediatrics')} >Book Visit</button>
                                </div>
                        ...
                        <div class="doctor2">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={Gowri_Somayaji} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    <div class="doctor-field mb-2 py-1 px-1">
                                        Pediatrician
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default"
                                    onClick={()=>saveDocInfo('2','Dr.Gowri Somayaji','MBBS-General Medicine,MD-Paediatrics','Pediatrician')} 
                                    >Book Visit</button>
                                </div>
                                {/* <div class="doctor-know-more mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default">Book Know More</button>
                        ...
                        <div class="doctor3">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={Subba_rao} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    <div class="doctor-field mb-2 py-1 px-1">
                                        Pediatrics
                                    ...
                                    <div class="doctor-qualification mb-2 py-1 px-1">
                                        MBBS-General Medicine, Diploma-Paediatrics, DNB-Paediatrics
                                    </div>
                                    <div class="doctor-exp-lang">
                                        <div class="doctor-exp  mb-2 py-1 px-1">
                                            44 years
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default"
                                    onClick={()=>saveDocInfo('3','Dr.Subba Rao','MBBS-General Medicine, Diploma-Paediatrics, DNB-Paediatrics','Pedaitrics')} 
                                    >Book Visit</button>
                                </div>
                                {/* <div class="doctor-know-more mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default">Book Know More</button>
