...
import SheetalKamath from "../images/Doctors/general_physician/Sheetal_Kamat.jpg";
import Devendrappa from "../images/Doctors/general_physician/Devendrappa.png";
import SheetalBramhesh from "../images/Doctors/general_physician/Sheetal_Bramhesh.jpg";
...
function GeneralPhysician()
{
    ...
    const saveDocInfo=(id,name,qual,field)=>{
        setDocId(id);
        if(id==='1')
            setDoc(SheetalKamath);
        else if(id==='2')
            setDoc(Devendrappa);
        else if(id==='3')
            setDoc(SheetalBramhesh);
        setDocName(name);
        setDocQual(qual);
        setDocField(field);
        changeDisplay();
    ...
    const selectTimeSlot=(startTime,endTime,index)=>{
        ...
        {
            currentIndexStatus.style.background='gray';
        }
        else{
    ...
    return(
                ...
                <div class="doctor-content">
                    <div class="doctor-content-holder  mx-auto my-auto">
                        ...
                        <div class="doctor1">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={SheetalKamath} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    ...
                                    <div class="doctor-qualification mb-2 py-1 px-1">
                                        MBBS-General Medicine,DNB-General Medicine
                                    </div>
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    ...
                                    onClick={()=>saveDocInfo('1','Dr.Sheetal Kamat','MBBS-General Medicine,DNB-General Medicine','General Physician')} >Book Visit</button>
                                </div>
                        ...
                        <div class="doctor2">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={Devendrappa} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    <div class="doctor-field mb-2 py-1 px-1">
                                        General Physician
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default"
                                    onClick={()=>saveDocInfo('2','Dr.Devendrappa','MBBS-General Medicine,MD-General Medicine','General Physician')} 
                                    >Book Visit</button>
                                </div>
                                {/* <div class="doctor-know-more mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default">Book Know More</button>
                        ...
                        <div class="doctor3">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={SheetalBramhesh} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    <div class="doctor-field mb-2 py-1 px-1">
                                        General Physician
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default"
                                    onClick={()=>saveDocInfo('3','Dr.Sheetal Bramhesh','MBBS-General Medicine','General Physician')} 
                                    >Book Visit</button>
                                </div>
                                {/* <div class="doctor-know-more mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default">Book Know More</button>
        ...
        <div id="showTimeSlots" class='pop-up' style={{display:'none'}}>
