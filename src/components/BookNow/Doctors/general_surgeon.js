...
import MuniReddy_M_V from "../images/Doctors/general_surgeon/MuniReddy_M_V.jpeg";
import Nanda_Rajaneesh from "../images/Doctors/general_surgeon/Nanda_Rajaneesh.jpeg";
import Parameshwara from "../images/Doctors/general_surgeon/Parameshwara.jpg";

function GeneralSurgeon()
{
    ...
    const saveDocInfo=(id,name,qual,field)=>{
        setDocId(id);
        if(id==='1')
            setDoc(MuniReddy_M_V);
        else if(id==='2')
            setDoc(Nanda_Rajaneesh);
        else if(id==='3')
            setDoc(Parameshwara);
        setDocName(name);
        setDocQual(qual);
                ...
                <div class="doctor-content">
                    <div class="doctor-content-holder  mx-auto my-auto">
                        ...
                        <div class="doctor1">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={MuniReddy_M_V} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    ...
                                    MBBS-General Medicine; MS-General Surgery, DNB-General Surgery, FSGE-Surg Gastrointestinal
                                    </div>
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    ...
                                    onClick={()=>saveDocInfo('1','Dr.MuniReddy M V','MBBS-General Medicine; MS-General Surgery, DNB-General Surgery, FSGE-Surg Gastrointestinal','General Surgeon')} >Book Visit</button>
                                </div>
                        ...
                        <div class="doctor2">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={Nanda_Rajaneesh} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    <div class="doctor-field mb-2 py-1 px-1">
                                        General Surgeon
                                    ...
                                    <div class="doctor-qualification mb-2 py-1 px-1">
                                    MBBS-General Medicine, MS-General Surgery
                                    </div>
                                    <div class="doctor-exp-lang">
                                        <div class="doctor-exp  mb-2 py-1 px-1">
                                            20 years
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default"
                                    onClick={()=>saveDocInfo('2','Dr.Nanda Rajaneesh','MBBS-General Medicine, MS-General Surgery','General Surgeon')} 
                                    >Book Visit</button>
                                </div>
                                {/* <div class="doctor-know-more mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default">Book Know More</button>
                        ...
                        <div class="doctor3">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={Parameshwara} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    <div class="doctor-field mb-2 py-1 px-1">
                                        General Surgeon
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default"
                                    onClick={()=>saveDocInfo('3','Dr.Parameshwara','MBBS-General Medicine, MS-General Surgery','General Surgeon')} 
                                    >Book Visit</button>
                                </div>
                                {/* <div class="doctor-know-more mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default">Book Know More</button>
