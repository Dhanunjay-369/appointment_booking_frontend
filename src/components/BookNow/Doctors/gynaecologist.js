...
import G_S_Rudrapal from "../images/Doctors/gynaecologist/G_S_Rudrapal.jpg";
import Nitha_Prasad from "../images/Doctors/gynaecologist/Nitha_Prasad.jpeg";
import Shobha_K from "../images/Doctors/gynaecologist/Shobha_K.jpeg";
...
function Gynaecologist()
{
    ...
    const changeDisplay=()=>{
        document.getElementById("gynaecology").style.display="none";
                ...
                <div class="doctor-content">
                    <div class="doctor-content-holder  mx-auto my-auto">
                        ...
                        <div class="doctor1">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={G_S_Rudrapal} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    ...
                                    MBBS-General Medicine, MS-Obsteatrics & Gynaecology, DNB-Obsteatrics & Gynaecology
                                    </div>
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    ...
                                    onClick={()=>saveDocInfo('1','Dr.G S Rudrapal','MBBS-General Medicine, MS-Obsteatrics & Gynaecology, DNB-Obsteatrics & Gynaecology','Gynaecologist')} >Book Visit</button>
                                </div>
                        ...
                        <div class="doctor2">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={Nitha_Prasad} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    <div class="doctor-field mb-2 py-1 px-1">
                                        Dermatologist
                                    ...
                                    <div class="doctor-qualification mb-2 py-1 px-1">
                                        MBBS-General Medicine, MS-Obsteatrics & Gynaecology
                                    </div>
                                    <div class="doctor-exp-lang">
                                        <div class="doctor-exp  mb-2 py-1 px-1">
                                            21 years
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default"
                                    onClick={()=>saveDocInfo('2','Dr.Nitha Prasad','MBBS-General Medicine, MS-Obsteatrics & Gynaecology','Gynaecologist')} 
                                    >Book Visit</button>
                                </div>
                                {/* <div class="doctor-know-more mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default">Book Know More</button>
                        ...
                        <div class="doctor3">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={Shobha_K} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    <div class="doctor-field mb-2 py-1 px-1">
                                        Gynaecologist
                                    ...
                                    <div class="doctor-qualification mb-2 py-1 px-1">
                                        MBBS-General Medicine, MS-Obsteatrics & Gynaecology, Mch-Onco Surgeon
                                    </div>
                                    <div class="doctor-exp-lang">
                                        <div class="doctor-exp  mb-2 py-1 px-1">
                                            15 years
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default"
                                    onClick={()=>saveDocInfo('3','Dr.Shobha K','MBBS-General Medicine, MS-Obsteatrics & Gynaecology, Mch-Onco Surgeon','Gynaecologist')} 
                                    >Book Visit</button>
                                </div>
                                {/* <div class="doctor-know-more mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default">Book Know More</button>
