...
import Amruthesh_T_M from "../images/Doctors/gastrentologist/Amruthesh_T_M.jpg";
import Anand_Dotihal from "../images/Doctors/gastrentologist/Anand_Dotihal.jpg";
import Kiran_R from "../images/Doctors/gastrentologist/Kiran_R.jpg";

function Gastroentologist()
{
    ...
    const changeDisplay=()=>{
        document.getElementById("gastroentology").style.display="none";
    ...
    const saveDocInfo=(id,name,qual,field)=>{
        setDocId(id);
        if(id==='1')
            setDoc(Amruthesh_T_M);
        else if(id==='2')
            setDoc(Anand_Dotihal);
        else if(id==='3')
            setDoc(Kiran_R);
        setDocName(name);
        setDocQual(qual);
                ...
                <div class="doctor-content">
                    <div class="doctor-content-holder  mx-auto my-auto">
                        ...
                        <div class="doctor1">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={Amruthesh_T_M} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    ...
                                    MBBS-General Medicine, MD-General Medicine, DNB-Gastroenterology
                                    </div>
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    ...
                                    onClick={()=>saveDocInfo('1','Dr.Amruthesh T M','MBBS-General Medicine, MD-General Medicine, DNB-Gastroenterology','Gastroentologist')} >Book Visit</button>
                                </div>
                        ...
                        <div class="doctor2">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={Anand_Dotihal} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    <div class="doctor-field mb-2 py-1 px-1">
                                        Gastroentologist
                                    ...
                                    <div class="doctor-qualification mb-2 py-1 px-1">
                                    MBBS-General Medicine, MD-General Medicine, DM-Gastroenterology
                                    </div>
                                    <div class="doctor-exp-lang">
                                        <div class="doctor-exp  mb-2 py-1 px-1">
                                            28 years
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default"
                                    onClick={()=>saveDocInfo('2','Dr.Anand Dotihal','MBBS-General Medicine, MD-General Medicine, DM-Gastroenterology','Gastroentologist')} 
                                    >Book Visit</button>
                                </div>
                                {/* <div class="doctor-know-more mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default">Book Know More</button>
                        ...
                        <div class="doctor3">
                            <div class="doctor">
                                <div class="doctor-image">
                                    <img src={Kiran_R} alt="Doctor" height="196" width="196"/>
                                </div>
                                <div class="doctor-oral-specifications">
                                    <div class="doctor-field mb-2 py-1 px-1">
                                        Gastrentologist
                            ...
                            <div class="doctor-visit px-auto py-auto">
                                ...
                                <div class="doctor-booking mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default"
                                    onClick={()=>saveDocInfo('3','Dr.Kiran R','MBBS-General Medicine, MD-General Medicine, DM-Gastroenterology','Gastroentologist')} 
                                    >Book Visit</button>
                                </div>
                                {/* <div class="doctor-know-more mx-1 my-1 py-1 px-1">
                                    <button type="button" class="btn btn-default">Book Know More</button>
...
export default Gastroentologist;
